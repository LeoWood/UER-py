...
--output_model_path /work1/zzx6320/lh/Projects/UER-py/output_pre/pubmed_bert_from_base_40gpus_conti_1.bin  \
--output_log_path /work1/zzx6320/lh/Projects/UER-py/output_pre/pubmed_bert_from_base_40gpus_conti_1.csv  \
