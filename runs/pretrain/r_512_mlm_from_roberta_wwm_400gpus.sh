...
--pretrained_model_path /work1/zzx6320/lh/Projects/UER-py/models/roberta_wwm_ext_model.bin \
--output_model_path /work1/zzx6320/lh/Projects/UER-py/output_pre/r_512_mlm_from_roberta_wwm_400gpus_debug.bin  \
--output_log_path /work1/zzx6320/lh/Projects/UER-py/output_pre/r_512_mlm_from_roberta_wwm_400gpus_debug.csv  \
