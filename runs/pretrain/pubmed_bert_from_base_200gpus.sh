...
--pretrained_model_path /work1/zzx6320/lh/Projects/UER-py/output_pre/pubmed_bert_from_base_200gpus_3w5.bin \
--output_model_path /work1/zzx6320/lh/Projects/UER-py/output_pre/pubmed_bert_from_base_200gpus_3w5_.bin  \
--output_log_path /work1/zzx6320/lh/Projects/UER-py/output_pre/pubmed_bert_from_base_200gpus_3w5_.csv  \
