...
--output_model_path /work1/zzx6320/lh/Projects/UER-py/output_pre/r_512_mlm_from_roberta_wwm_120gpus_hand.bin  \
--output_log_path /work1/zzx6320/lh/Projects/UER-py/output_pre/r_512_mlm_from_roberta_wwm_120gpus_hand.csv  \
