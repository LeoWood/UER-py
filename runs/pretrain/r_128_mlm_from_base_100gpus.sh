...
--output_model_path /work1/zzx6320/lh/Projects/UER-py/output_pre/r_128_mlm_from_base_100gpus.bin  \
--output_log_path /work1/zzx6320/lh/Projects/UER-py/output_pre/r_128_mlm_from_base_100gpus.csv  \
