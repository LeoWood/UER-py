...
def main_worker(gpu, ngpus_per_node, args, model):
    ...
    dist.init_process_group(backend=args.dist_backend, init_method=args.dist_url,
                                world_size=args.world_size, rank=args.rank,timeout=timedelta(seconds=60))
	...
	#print batch_time.val, batch_time.count, batch_time.sum
	   ...
	   # print("Performance: {} ", images_per_sec)
        ...
        if i == 110:
           ...
           print("workers is ", args.workers)
           if args.world_size == -1:
              images_total_per_sec=args.batch_size * 100 / time_print_step
              #images_total_per_sec=args.batch_size * 100 * args.world_size / time_print_step
           else:
              images_total_per_sec=args.batch_size * 100 * args.world_size / time_print_step
           #images_total_per_sec2=args.batch_size * 100 / batch_time.sum
           print("Total Performance: {} samples/sec".format(images_total_per_sec))
           #print("Total Performance: {} samples/sec".format(images_total_per_sec2))
           break
